...
export class setUuid1669932517014 implements MigrationInterface {
    name = 'setUuid1669932517014'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "contact_emails" ("id" character varying NOT NULL, "email" character varying(40) NOT NULL, "contactId" character varying, CONSTRAINT "PK_fe57f999770a7da0338a9b29db3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_emails" ("id" character varying NOT NULL, "email" character varying(40) NOT NULL, "userId" character varying, CONSTRAINT "PK_3ef6c4be97ba94ea3ba65362ad0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_numbers" ("id" character varying NOT NULL, "number" character varying(13) NOT NULL, "userId" character varying, CONSTRAINT "PK_1646e309d15fbcb76434385ac2f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" character varying NOT NULL, "full_name" character varying(50) NOT NULL, "password" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_0adc0a8834ea0f252e96d154de9" UNIQUE ("full_name"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "contacts" ("id" character varying NOT NULL, "full_name" character varying(50) NOT NULL, "userId" character varying, CONSTRAINT "PK_b99cd40cfd66a99f1571f4f72e6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "contact_numbers" ("id" character varying NOT NULL, "number" character varying(13) NOT NULL, "contactId" character varying, CONSTRAINT "PK_f5733cf0d0034ad0b57fb822bb2" PRIMARY KEY ("id"))`);
